...
-- CreateEnum
CREATE TYPE "ModuleName" AS ENUM ('SIEM', 'SOAR', 'CTI', 'EDR', 'DFIR', 'VM');

-- CreateEnum
CREATE TYPE "ModuleSourceType" AS ENUM ('PLATFORM', 'OWN');
...
CREATE TABLE "TenantModule" (
    ...
    "sourceType" "ModuleSourceType" NOT NULL DEFAULT 'PLATFORM',
    "config" JSONB,
...
-- CreateIndex
CREATE UNIQUE INDEX "TenantModule_tenantId_moduleName_key" ON "TenantModule"("tenantId", "moduleName");
